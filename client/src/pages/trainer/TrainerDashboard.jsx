      ...
      <aside className={`sidebar ${isOpen ? "open" : "closed"}`}>
        <div className="sidebar-header">
          <div className="logo-section">
            ...
            {isOpen && <span className="logo-text">Trainer Dashboard</span>}
          </div>
        ...
        <nav className="sidebar-nav">
          <ul>
              ...
              <li className='active'>
                <Link to="addskills">
                  <span className="icon">  <Users size={20} /> Add Skills </span>
                  {isOpen && <span className="text"></span>}
                </Link>
              </li>
              <li className='active'>
                <Link to="content">
                  <span className="icon"><BookOpen size={20} /> Add Content </span>
                  {isOpen && <span className="text"></span>}
                </Link>
              </li>
              <li className='active'>
